...
class StateItemsBoard(State, ButtonListener):
    ...
    def draw_items_menu(self):
        ...
        self.display_starting_gold(Consts.MONEY) ################################ needs starting gold
