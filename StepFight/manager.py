...
from stateWelcomeScreen import StateWelcomeScreen
...
class Manager:
    ...
    #Initial state
    #state = StateItemsBoard(screen, inputManager, character) #change to welcome screen
    #gold_and_description = user_interface.run()
    Consts.MONEY = 4000#gold_and_description[0]
    
    description = "Step Fight!" #gold_and_description[1]
    state = StateWelcomeScreen(screen, inputManager, character, description)
